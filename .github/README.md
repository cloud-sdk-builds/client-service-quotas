...
[`@aws-sdk/client-service-quotas`](https://www.npmjs.com/package/@aws-sdk/client-service-quotas/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-quotas@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BgAAyq0liJviITPuKztgem5I/au2tSVeC+y6P3dfOi+ku1+3LiqJEsD6F0PNdIOA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-service-quotas": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-quotas@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-quotas@3.94.0/index.min.mjs": "sha384-BgAAyq0liJviITPuKztgem5I/au2tSVeC+y6P3dfOi+ku1+3LiqJEsD6F0PNdIOA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-service-quotas/blob/refs/tags/3.94.0/LICENSE
```
